  ...
  genFilename(selectedDateRange: SelectedDateRange): string {
    if (selectedDateRange === undefined) {
      ...
      return `${formatDate(
        ...
        'yyyyLLdd',
        'en-ZM'
      )}_Agent_${this.agent$.phone_number}_MobiCom_Transactions`;
    } else {
      return `${formatDate(
        this.selectedDateRange.from,
        'yyyyLLdd',
  ...
  genSalesFilename(selectedDateRange: SelectedDateRange): string {
    if (selectedDateRange === undefined) {
      ...
      return `${formatDate(
        ...
        'yyyyLLdd',
        'en-ZM'
      )}_Agent_${this.agent$.phone_number}_MobiCom_Sales`;
    } else {
      return `${formatDate(
        selectedDateRange.from,
        'yyyyLLdd',
